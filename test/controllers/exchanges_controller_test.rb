...
class ExchangesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exchange" do
    assert_difference('Exchange.count') do
      post exchanges_url, params: { exchange: { facebook: @exchange.facebook, linkedin: @exchange.linkedin, location: @exchange.location, name: @exchange.name, twitter: @exchange.twitter, website: @exchange.website } }
    end
  ...
  test "should update exchange" do
    patch exchange_url(@exchange), params: { exchange: { facebook: @exchange.facebook, linkedin: @exchange.linkedin, location: @exchange.location, name: @exchange.name, twitter: @exchange.twitter, website: @exchange.website } }
