...
class TokensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create token" do
    assert_difference('Token.count') do
      post tokens_url, params: { token: { company_id: @token.company_id, exchange_id: @token.exchange_id, name: @token.name } }
    end
  ...
  test "should update token" do
    patch token_url(@token), params: { token: { company_id: @token.company_id, exchange_id: @token.exchange_id, name: @token.name } }
