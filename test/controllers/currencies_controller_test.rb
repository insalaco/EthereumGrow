...
class CurrenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create currency" do
    assert_difference('Currency.count') do
      post currencies_url, params: { currency: { company_id: @currency.company_id, exchange_id: @currency.exchange_id, name: @currency.name } }
    end
  ...
  test "should update currency" do
    patch currency_url(@currency), params: { currency: { company_id: @currency.company_id, exchange_id: @currency.exchange_id, name: @currency.name } }
